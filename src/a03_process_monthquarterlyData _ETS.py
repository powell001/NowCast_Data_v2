...
def monthlydata():
    ...
    a0_combinedMonthly_extended.to_csv("output_combined/a0_combinedMonthly_extended_ETS.csv")
...
def qtdata(donothing=True):
    ...
    if donothing:
        data.to_csv("output_combined/a0_combinedQuarterly_extended_ETS.csv")
        ...
        xxx.to_csv("output_combined/a0_combinedMonthly_extended_ETS.csv")
